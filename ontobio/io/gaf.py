...
from ontobio.io.gafparser import ENTITY, EXTENSION, ANNOTATION

class GafParser(gafparser.AssocParser):
    """
    ...
    def parse_line(self, line):
        ...
        return gafparser.ParseResult(line, assocs, False, evidence.upper())
